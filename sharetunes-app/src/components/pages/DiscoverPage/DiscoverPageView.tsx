...
const DiscoverPageView: React.FC<Props> = ({
    user,
    posts,
    handleAudio,
    isPlaying,
    ...
    return (
        <div>
                        ...
                        return (
                            <div className={classes.card}>
                                <div className={classes.header}>
                                    <div className={classes.userPicture}></div>
			...
			C478.557,151.509,448.737,121.689,412.082,121.689z"
                ...
                <div className={classes.discoverSidebar}>
                    <div className={classes.popularSongs}>
                        <div className={classes.sideBarText}>Popular Songs</div>
                                ...
                                return (
                                    <div>
                                        <div className={classes.songCard}>
                                            <div
                                                className={
                                                    classes.songCardImage
                                                }
                                            >
                                                <img
                                                    src={song.albumCoverSmall}
                                                ></img>
                                            </div>
                                            <div
                                                className={classes.songCardSong}
                                            >
                                                <div
                                                    className={
                                                        classes.songCardTitle
                                                    }
                                                >
                                                    <svg
                                                        className={
                                                            classes.songCardTitleImage
                                                        }
                                                        version="1.1"
                                                        id="Capa_1"
                                                        xmlns="http://www.w3.org/2000/svg"
			...
			C478.557,151.509,448.737,121.689,412.082,121.689z"
                                            ...
                                            <div
                                                className={
                                                    classes.songCardPlayer
                                                }
                                                onClick={() => {
                                                    handleAudio(song.preview);
                                                }}
                                            >
                                                {isPlaying(song.preview) ? (
                                                    <svg
                                                        className={
                                                            classes.songCardPlayerImage
                                                        }
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        width="16"
                                                        height="16"
